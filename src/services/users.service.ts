...
export const usersService = {
  ...
  async deleteTeamMember(id: string): Promise<void> {
    // First check if this user has any related data
    ...
    if (error) {
      ...
      if (error.code === '23503') {
        throw new Error('Não é possível excluir este usuário pois ele possui dados vinculados (coletas, monitoramentos, etc)')
      }
      throw error
    }
  },
