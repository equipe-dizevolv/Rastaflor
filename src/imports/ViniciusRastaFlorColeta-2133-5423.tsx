import svgPaths from "./svg-1jdtjornj9";
...
function Button24() {
  return (
    <div className="absolute bg-[#0f3d26] h-[39.948px] left-[15.99px] rounded-[10px] top-0 w-[186.644px]" data-name="Button">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[11.98px] text-[14px] text-neutral-50 text-nowrap top-[7.99px] whitespace-pre">Dados Gerais</p>
    </div>
  );
}
...
function Button25() {
  return (
    <div className="absolute h-[39.948px] left-[15.99px] rounded-[10px] top-[45.93px] w-[186.644px]" data-name="Button">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[11.98px] text-[#9da29f] text-[14px] text-nowrap top-[7.99px] whitespace-pre">Proprietário(s)</p>
    </div>
  );
}
...
function Container23() {
  return (
    <div className="bg-[#1f2923] h-[499.988px] relative shrink-0 w-[219.991px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-[499.988px] items-start pb-0 pl-0 pr-[1.372px] pt-[11.98px] relative w-[219.991px]">
        <Navigation1 />
      </div>
    </div>
  );
...
function Heading2() {
  return (
    <div className="h-[27.989px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[28px] left-0 text-[18px] text-neutral-50 text-nowrap top-[-1.63px] whitespace-pre">Dados Gerais</p>
    </div>
  );
}
...
function PrimitiveLabel() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Nome da Propriedade</p>
    </div>
  );
}
...
function Input() {
  return (
    <div className="bg-[#121714] h-[39.99px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[39.99px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Fazenda São João</p>
        </div>
      </div>
...
function Container24() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5.979px] h-[59.964px] items-start left-0 top-0 w-[209.747px]" data-name="Container">
      <PrimitiveLabel />
      <Input />
    </div>
  );
...
function PrimitiveLabel1() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">CEP</p>
    </div>
  );
}
...
function Input1() {
  return (
    <div className="bg-[#121714] h-[39.99px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[39.99px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#717182] text-[14px] text-nowrap whitespace-pre">00000-000</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#121714] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container25() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5.979px] h-[59.964px] items-start left-0 top-[83.95px] w-[209.747px]" data-name="Container">
      <PrimitiveLabel1 />
      <Input1 />
    </div>
  );
...
function PrimitiveLabel2() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Logradouro</p>
    </div>
  );
}
...
function Input2() {
  return (
    <div className="bg-[#121714] h-[39.99px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[39.99px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#717182] text-[14px] text-nowrap whitespace-pre">Rua, Avenida...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#121714] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5.979px] h-[59.964px] items-start left-0 top-[167.89px] w-[209.747px]" data-name="Container">
      <PrimitiveLabel2 />
      <Input2 />
    </div>
  );
...
function PrimitiveLabel3() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Número</p>
    </div>
  );
}
...
function Input3() {
  return (
    <div className="bg-[#121714] h-[39.99px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[39.99px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#717182] text-[14px] text-nowrap whitespace-pre">123</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#121714] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container27() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5.979px] h-[59.964px] items-start left-0 top-[251.84px] w-[209.747px]" data-name="Container">
      <PrimitiveLabel3 />
      <Input3 />
    </div>
  );
...
function PrimitiveLabel4() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Complemento</p>
    </div>
  );
}
...
function Input4() {
  return (
    <div className="bg-[#121714] h-[39.99px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[39.99px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#717182] text-[14px] text-nowrap whitespace-pre">Apto, Bloco...</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#121714] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5.979px] h-[59.964px] items-start left-0 top-[335.78px] w-[209.747px]" data-name="Container">
      <PrimitiveLabel4 />
      <Input4 />
    </div>
  );
...
function PrimitiveLabel5() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Bairro</p>
    </div>
  );
}
...
function Container29() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5.979px] h-[59.964px] items-start left-0 top-[419.73px] w-[209.747px]" data-name="Container">
      <PrimitiveLabel5 />
      <Input5 />
    </div>
  );
...
function PrimitiveLabel6() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Cidade e Estado</p>
    </div>
  );
}
...
function Input6() {
  return (
    <div className="bg-[#121714] h-[39.99px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[39.99px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">São Paulo - SP</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#121714] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5.979px] h-[59.964px] items-start left-0 top-[503.67px] w-[209.747px]" data-name="Container">
      <PrimitiveLabel6 />
      <Input6 />
    </div>
  );
...
function PrimitiveLabel7() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Número do CAR</p>
    </div>
  );
}
...
function Input7() {
  return (
    <div className="bg-[#121714] h-[39.99px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[39.99px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#717182] text-[14px] text-nowrap whitespace-pre">CAR-XXXX-XXXX</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#121714] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container31() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5.979px] h-[59.964px] items-start left-0 top-[587.62px] w-[209.747px]" data-name="Container">
      <PrimitiveLabel7 />
      <Input7 />
    </div>
  );
...
function PrimitiveLabel8() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Latitude</p>
    </div>
  );
}
...
function Input8() {
  return (
    <div className="bg-[#121714] h-[39.99px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[39.99px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#717182] text-[14px] text-nowrap whitespace-pre">-23.5505</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#121714] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container32() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5.979px] h-[59.964px] items-start left-0 top-[671.57px] w-[209.747px]" data-name="Container">
      <PrimitiveLabel8 />
      <Input8 />
    </div>
  );
...
function PrimitiveLabel9() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Longitude</p>
    </div>
  );
}
...
function Input9() {
  return (
    <div className="bg-[#121714] h-[39.99px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[39.99px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#717182] text-[14px] text-nowrap whitespace-pre">-46.6333</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#121714] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container33() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[5.979px] h-[59.964px] items-start left-0 top-[755.51px] w-[209.747px]" data-name="Container">
      <PrimitiveLabel9 />
      <Input9 />
    </div>
  );
...
function Container34() {
  return (
    <div className="h-[815.476px] relative shrink-0 w-full" data-name="Container">
      <Container24 />
      <Container25 />
      <Container26 />
      <Container27 />
...
function PrimitiveLabel10() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[13.995px] items-center left-0 top-0 w-[145.775px]" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[14px] text-neutral-50 text-nowrap whitespace-pre">Status</p>
    </div>
  );
}
...
function Paragraph4() {
  return (
    <div className="absolute h-[39.948px] left-0 top-[13.99px] w-[145.775px]" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#9da29f] text-[14px] top-[-2px] w-[129px]">Propriedade ativa no sistema</p>
    </div>
  );
}
...
function Container35() {
  return (
    <div className="absolute h-[53.942px] left-[15.99px] top-[15.99px] w-[145.775px]" data-name="Container">
      <PrimitiveLabel10 />
      <Paragraph4 />
    </div>
  );
...
function PrimitiveSpan() {
  return (
    <div className="bg-white relative rounded-[4.6023e+07px] shrink-0 size-[15.988px]" data-name="Primitive.span">
...
function PrimitiveButton() {
  return (
    <div className="absolute bg-[#0f3d26] box-border content-stretch flex h-[18.388px] items-center left-[161.76px] pl-[15.359px] pr-[1.372px] py-[1.372px] rounded-[4.6023e+07px] top-[33.75px] w-[31.997px]" data-name="Primitive.button">
      <div aria-hidden="true" className="absolute border-[1.372px] border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[4.6023e+07px]" />
      <PrimitiveSpan />
    </div>
  );
}
...
function Container36() {
  return (
    <div className="bg-[#121714] h-[85.917px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
      <Container35 />
      <PrimitiveButton />
    </div>
  );
...
function Container37() {
  return (
    <div className="content-stretch flex flex-col gap-[23.981px] h-[977.345px] items-start relative shrink-0 w-full" data-name="Container">
      <Heading2 />
      <Container34 />
      <Container36 />
    </div>
...
function Container38() {
  return (
    <div className="basis-0 bg-[#2b3630] grow h-[499.988px] min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-[499.988px] items-start pb-0 pl-[23.981px] pr-[55.528px] pt-[23.981px] relative w-full">
          <Container37 />
        </div>
      </div>
    </div>
...
function ModalEditarPropriedade() {
  return (
    <div className="absolute content-stretch flex h-[499.988px] items-start left-[1.37px] overflow-clip top-[90.68px] w-[509.247px]" data-name="ModalEditarPropriedade">
      <Container23 />
      <Container38 />
    </div>
  );
...
function ModalEditarPropriedade1() {
  return (
    <div className="absolute box-border content-stretch flex gap-[11.98px] h-[69.33px] items-start justify-end left-[1.37px] pb-0 pl-0 pr-[23.981px] pt-[17.36px] top-[590.66px] w-[509.247px]" data-name="ModalEditarPropriedade">
...
function PrimitiveDiv1() {
  return (
    <div className="absolute bg-[#2b3630] h-[661.365px] left-[774.76px] rounded-[10px] top-[95.2px] w-[511.99px]" data-name="Primitive.div">
      <div className="h-[661.365px] overflow-clip relative rounded-[inherit] w-[511.99px]">
        <DialogHeader />
