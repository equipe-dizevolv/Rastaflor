import svgPaths from "./svg-ofzjz4jf8h";
...
function Icon6() {
  return (
    <div className="absolute left-[9.37px] size-[15.988px] top-[5.83px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_2132_4290)" id="Icon">
          <path d={svgPaths.p3d46cff0} id="Vector" stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3323" />
          <path d="M7.99381 12.6569V14.6553" id="Vector_2" stroke="var(--stroke-0, #FAFAFA)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.3323" />
        </g>
        <defs>
          <clipPath id="clip0_2132_4290">
            <rect fill="white" height="15.9876" width="15.9876" />
          </clipPath>
        </defs>
      </svg>
...
function PrimitiveButton2() {
  return (
    <div className="basis-0 bg-[#0f3d26] grow h-[27.646px] min-h-px min-w-px relative rounded-[14px] shrink-0" data-name="Primitive.button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[27.646px] relative w-full">
        <Icon6 />
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[92.33px] text-[14px] text-center text-neutral-50 text-nowrap top-[1.84px] translate-x-[-50%] whitespace-pre">Árvores Matrizes</p>
      </div>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="content-stretch flex h-[24.003px] items-start relative shrink-0 w-full" data-name="Heading 3">
      <p className="basis-0 font-['Arimo:Regular',sans-serif] font-normal grow leading-[24px] min-h-px min-w-px relative shrink-0 text-[#1a1a1a] text-[16px]">Árvores Matrizes da Propriedade</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[19.974px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-0 text-[#777777] text-[14px] top-[-2px] w-[383px]">Gerenciamento de matrizes cadastradas em Fazenda São João</p>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="h-[47.963px] relative shrink-0 w-[382.246px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[3.986px] h-[47.963px] items-start relative w-[382.246px]">
        <Heading2 />
        <Paragraph1 />
      </div>
    </div>
...
function Button1() {
  return (
    <div className="bg-[#0f3d26] h-[35.983px] relative rounded-[8px] shrink-0 w-[198.217px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[35.983px] relative w-[198.217px]">
        <Icon7 />
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[20px] left-[114.96px] text-[14px] text-center text-neutral-50 text-nowrap top-[5.99px] translate-x-[-50%] whitespace-pre">Adicionar Nova Matriz</p>
      </div>
    </div>
  );
}
...
function Container9() {
  return (
    <div className="content-stretch flex h-[47.963px] items-center justify-between relative shrink-0 w-full" data-name="Container">
      <Container8 />
      <Button1 />
    </div>
  );
...
function Icon8() {
  return (
    <div className="absolute left-0 size-[19.995px] top-0" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_2132_4286)" id="Icon">
          <path d={svgPaths.p406d640} id="Vector" stroke="var(--stroke-0, #16A34A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66627" />
          <path d="M9.99762 15.8296V18.329" id="Vector_2" stroke="var(--stroke-0, #16A34A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66627" />
        </g>
        <defs>
          <clipPath id="clip0_2132_4286">
            <rect fill="white" height="19.9952" width="19.9952" />
          </clipPath>
        </defs>
      </svg>
...
function CardTitle() {
  return (
    <div className="h-[19.995px] relative shrink-0 w-[200.638px]" data-name="CardTitle">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[19.995px] relative w-[200.638px]">
        <Icon8 />
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[16px] left-[27.99px] text-[#1a1a1a] text-[16px] top-[-1.12px] w-[173px]">Matrizes Cadastradas (3)</p>
      </div>
    </div>
  );
}
...
function AbaArvoresMatrizes() {
  return (
    <div className="h-[35.983px] relative shrink-0 w-[1690.81px]" data-name="AbaArvoresMatrizes">
...
function HeaderCell() {
  return (
    <div className="absolute h-[44.62px] left-0 top-0 w-[210.754px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-[15.99px] text-[#777777] text-[14px] text-nowrap top-[9.98px] whitespace-pre">ID</p>
    </div>
  );
}
...
function HeaderCell1() {
  return (
    <div className="absolute h-[44.62px] left-[210.75px] top-0 w-[441.203px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-[15.99px] text-[#777777] text-[14px] text-nowrap top-[9.98px] whitespace-pre">Espécie</p>
    </div>
  );
}
...
function HeaderCell2() {
  return (
    <div className="absolute h-[44.62px] left-[651.96px] top-0 w-[366.129px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-[15.99px] text-[#777777] text-[14px] text-nowrap top-[9.98px] whitespace-pre">Área na Propriedade</p>
    </div>
  );
}
...
function HeaderCell3() {
  return (
    <div className="absolute h-[44.62px] left-[1018.09px] top-0 w-[273.461px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-[15.99px] text-[#777777] text-[14px] text-nowrap top-[9.98px] whitespace-pre">Data Cadastro</p>
    </div>
  );
}
...
function HeaderCell4() {
  return (
    <div className="absolute h-[44.62px] left-[1291.55px] top-0 w-[171.342px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-[15.99px] text-[#777777] text-[14px] text-nowrap top-[9.98px] whitespace-pre">Status</p>
    </div>
  );
}
...
function HeaderCell5() {
  return (
    <div className="absolute h-[44.62px] left-[1462.89px] top-0 w-[227.92px]" data-name="Header Cell">
      <p className="absolute font-['Arimo:Bold',sans-serif] font-bold leading-[20px] left-[212.1px] text-[#777777] text-[14px] text-nowrap text-right top-[9.98px] translate-x-[-100%] whitespace-pre">Ações</p>
    </div>
  );
}
...
function TableCell() {
  return (
    <div className="absolute h-[69.308px] left-0 top-0 w-[210.754px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[15.99px] text-[#1a1a1a] text-[16px] text-nowrap top-[19.65px] whitespace-pre">MAT-001</p>
    </div>
  );
}
...
function Container10() {
  return (
    <div className="absolute content-stretch flex h-[24.003px] items-start left-[15.99px] top-[12.67px] w-[409.227px]" data-name="Container">
...
function Container11() {
  return (
    <div className="absolute content-stretch flex h-[19.974px] items-start left-[15.99px] top-[36.67px] w-[409.227px]" data-name="Container">
...
function TableCell1() {
  return (
    <div className="absolute h-[69.308px] left-[210.75px] top-0 w-[441.203px]" data-name="Table Cell">
      <Container10 />
      <Container11 />
    </div>
  );
...
function TableCell2() {
  return (
    <div className="absolute h-[69.308px] left-[651.96px] top-0 w-[366.129px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[15.99px] text-[#1a1a1a] text-[16px] text-nowrap top-[19.65px] whitespace-pre">Área Norte</p>
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="absolute h-[69.308px] left-[1018.09px] top-0 w-[273.461px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[15.99px] text-[#1a1a1a] text-[16px] text-nowrap top-[19.65px] whitespace-pre">14/01/2025</p>
    </div>
  );
}
...
function Badge() {
  return (
    <div className="absolute bg-green-600 h-[22.717px] left-[15.99px] rounded-[8px] top-[24.35px] w-[46.206px]" data-name="Badge">
      <div className="h-[22.717px] overflow-clip relative rounded-[inherit] w-[46.206px]">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[16px] left-[9.37px] text-[12px] text-neutral-50 text-nowrap top-[2.36px] whitespace-pre">Ativa</p>
      </div>
...
function TableCell4() {
  return (
    <div className="absolute h-[69.308px] left-[1291.55px] top-0 w-[171.342px]" data-name="Table Cell">
      <Badge />
    </div>
  );
}
...
function Container12() {
  return (
    <div className="absolute content-stretch flex gap-[7.994px] h-[31.997px] items-start justify-end left-[15.99px] top-[18.65px] w-[195.945px]" data-name="Container">
      <Button3 />
      <Button4 />
    </div>
  );
...
function TableCell5() {
  return (
    <div className="absolute h-[69.308px] left-[1462.89px] top-0 w-[227.92px]" data-name="Table Cell">
      <Container12 />
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="absolute h-[69.308px] left-0 top-0 w-[210.754px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[15.99px] text-[#1a1a1a] text-[16px] text-nowrap top-[19.65px] whitespace-pre">MAT-003</p>
    </div>
  );
}
...
function TableCell8() {
  return (
    <div className="absolute h-[69.308px] left-[651.96px] top-0 w-[366.129px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[15.99px] text-[#1a1a1a] text-[16px] text-nowrap top-[19.65px] whitespace-pre">Área Sul</p>
    </div>
  );
}
...
function TableCell9() {
  return (
    <div className="absolute h-[69.308px] left-[1018.09px] top-0 w-[273.461px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[15.99px] text-[#1a1a1a] text-[16px] text-nowrap top-[19.65px] whitespace-pre">04/03/2025</p>
    </div>
  );
}
...
function TableCell12() {
  return (
    <div className="absolute h-[69.308px] left-0 top-0 w-[210.754px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[15.99px] text-[#1a1a1a] text-[16px] text-nowrap top-[19.65px] whitespace-pre">MAT-007</p>
    </div>
  );
}
...
function TableCell15() {
  return (
    <div className="absolute h-[69.308px] left-[1018.09px] top-0 w-[273.461px]" data-name="Table Cell">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[24px] left-[15.99px] text-[#1a1a1a] text-[16px] text-nowrap top-[19.65px] whitespace-pre">19/05/2025</p>
    </div>
  );
}
...
function TableBody() {
  return (
    <div className="absolute h-[207.925px] left-0 top-[44.62px] w-[1690.81px]" data-name="Table Body">
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
    </div>
...
function AbaArvoresMatrizes1() {
  return (
    <div className="h-[253.23px] relative shrink-0 w-[1690.81px]" data-name="AbaArvoresMatrizes">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[253.23px] overflow-clip relative rounded-[inherit] w-[1690.81px]">
        <TableHeader />
        <TableBody />
      </div>
    </div>
...
function Card2() {
  return (
    <div className="bg-white h-[369.88px] relative rounded-[14px] shrink-0 w-full" data-name="Card">
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[14px] shadow-[0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_-1px_rgba(0,0,0,0.1)]" />
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[29.961px] h-[369.88px] items-start pb-[1.372px] pl-[25.353px] pr-[1.372px] pt-[25.353px] relative w-full">
          <AbaArvoresMatrizes />
          <AbaArvoresMatrizes1 />
        </div>
      </div>
...
function AbaArvoresMatrizes2() {
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[1741.52px]" data-name="AbaArvoresMatrizes">
...
function PrimitiveDiv() {
  return (
    <div className="content-stretch flex flex-col gap-[31.975px] h-[509.782px] items-start relative shrink-0 w-full" data-name="Primitive.div">
      <TabList />
      <AbaArvoresMatrizes2 />
    </div>
  );
...
function DetalhesPropriedade2() {
  return (
    <div className="h-[740.403px] relative shrink-0 w-full" data-name="DetalhesPropriedade">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[23.981px] h-[740.403px] items-start pb-0 pt-[31.997px] px-[31.997px] relative w-full">
          <Container7 />
          <PrimitiveDiv />
        </div>
      </div>
