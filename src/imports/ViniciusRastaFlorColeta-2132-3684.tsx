import svgPaths from "./svg-vylkh7nglq";
  ...
  return (
    <div className="h-[24.003px] relative shrink-0 w-[11.98px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex h-[24.003px] items-start relative w-[11.98px]">
        <p className="font-['Arimo:Regular','Noto_Sans_Symbols2:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[16px] text-green-600 text-nowrap whitespace-pre">✓</p>
      </div>
    </div>
  );
}
