import svgPaths from "./svg-pvmwkunvcj";
...
function ListaPropriedades2() {
  return (
    <div className="h-[708.428px] relative shrink-0 w-full" data-name="ListaPropriedades">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[23.981px] h-[708.428px] items-start pb-0 pt-[31.997px] px-[31.997px] relative w-full">
          <Container1 />
          <Card />
        </div>
      </div>
...
function Heading1() {
  return (
    <div className="h-[27.989px] relative shrink-0 w-[143.974px]" data-name="Heading 2">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[27.989px] relative w-[143.974px]">
        <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[28px] left-0 text-[#1a1a1a] text-[18px] text-nowrap top-[-1.63px] whitespace-pre">Nova Propriedade</p>
      </div>
    </div>
  );
}
      ...
      <div className="absolute inset-1/4" data-name="Vector">
        <div className="absolute inset-[-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
            <path d={svgPaths.p31c6022} id="Vector" stroke="var(--stroke-0, #777777)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66627" />
          </svg>
        </div>
      </div>
      <div className="absolute inset-1/4" data-name="Vector">
        <div className="absolute inset-[-8.33%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 12">
            <path d={svgPaths.pa295720} id="Vector" stroke="var(--stroke-0, #777777)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66627" />
          </svg>
        </div>
      </div>
    </div>
...
function Button24() {
  return (
    <div className="relative shrink-0 size-[19.995px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col items-start relative size-[19.995px]">
        <Icon25 />
      </div>
    </div>
  );
...
function Container23() {
  return (
    <div className="h-[77.324px] relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[0px_0px_1.372px] border-solid inset-0 pointer-events-none" />
      <div className="flex flex-row items-center size-full">
        <div className="box-border content-stretch flex h-[77.324px] items-center justify-between pb-[1.372px] pt-0 px-[23.981px] relative w-full">
          <Heading1 />
          <Button24 />
        </div>
      </div>
...
function MiniModalCadastroPropriedade() {
  return (
    <div className="absolute h-[13.995px] left-[148.47px] top-0 w-[6.086px]" data-name="MiniModalCadastroPropriedade">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[#fb2c36] text-[14px] text-nowrap top-[-1.74px] whitespace-pre">*</p>
    </div>
  );
}
...
function PrimitiveLabel() {
  return (
    <div className="h-[13.995px] relative shrink-0 w-full" data-name="Primitive.label">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[#1a1a1a] text-[14px] text-nowrap top-[-1.74px] whitespace-pre">Nome da propriedade</p>
      <MiniModalCadastroPropriedade />
    </div>
  );
}
...
function Input() {
  return (
    <div className="bg-[#f8f8f8] h-[35.983px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[35.983px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#777777] text-[14px] text-nowrap whitespace-pre">Ex: Fazenda São João</p>
        </div>
      </div>
...
function Container24() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.994px] h-[57.971px] items-start left-0 top-0 w-[410.642px]" data-name="Container">
      <PrimitiveLabel />
      <Input />
    </div>
  );
...
function MiniModalCadastroPropriedade1() {
  return (
    <div className="absolute h-[13.995px] left-[60.14px] top-0 w-[6.086px]" data-name="MiniModalCadastroPropriedade">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[#fb2c36] text-[14px] text-nowrap top-[-1.74px] whitespace-pre">*</p>
    </div>
  );
}
...
function PrimitiveLabel1() {
  return (
    <div className="h-[13.995px] relative shrink-0 w-full" data-name="Primitive.label">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[#1a1a1a] text-[14px] text-nowrap top-[-1.74px] whitespace-pre">Número</p>
      <MiniModalCadastroPropriedade1 />
    </div>
  );
}
...
function Input1() {
  return (
    <div className="bg-[#f8f8f8] h-[35.983px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[35.983px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#777777] text-[14px] text-nowrap whitespace-pre">Ex: 12345-678</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container25() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.994px] h-[57.971px] items-start left-0 top-[81.95px] w-[410.642px]" data-name="Container">
      <PrimitiveLabel1 />
      <Input1 />
    </div>
  );
...
function PrimitiveLabel2() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[#1a1a1a] text-[14px] text-nowrap whitespace-pre">Bairro</p>
    </div>
  );
}
...
function Input2() {
  return (
    <div className="bg-[#f8f8f8] h-[35.983px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[35.983px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#777777] text-[14px] text-nowrap whitespace-pre">Ex: 123</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container26() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.994px] h-[57.971px] items-start left-0 top-[163.91px] w-[410.642px]" data-name="Container">
      <PrimitiveLabel2 />
      <Input2 />
    </div>
  );
...
function MiniModalCadastroPropriedade2() {
  return (
    <div className="absolute h-[13.995px] left-[51.95px] top-0 w-[6.086px]" data-name="MiniModalCadastroPropriedade">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[#fb2c36] text-[14px] text-nowrap top-[-1.74px] whitespace-pre">*</p>
    </div>
  );
}
...
function PrimitiveLabel3() {
  return (
    <div className="h-[13.995px] relative shrink-0 w-full" data-name="Primitive.label">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[#1a1a1a] text-[14px] text-nowrap top-[-1.74px] whitespace-pre">Cidade</p>
      <MiniModalCadastroPropriedade2 />
    </div>
  );
}
...
function Input3() {
  return (
    <div className="bg-[#f8f8f8] h-[35.983px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[35.983px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#777777] text-[14px] text-nowrap whitespace-pre">Ex: Zona Rural</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container27() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.994px] h-[57.971px] items-start left-0 top-[245.86px] w-[410.642px]" data-name="Container">
      <PrimitiveLabel3 />
      <Input3 />
    </div>
  );
...
function MiniModalCadastroPropriedade3() {
  return (
    <div className="absolute h-[13.995px] left-[59.94px] top-0 w-[6.086px]" data-name="MiniModalCadastroPropriedade">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[#fb2c36] text-[14px] text-nowrap top-[-1.74px] whitespace-pre">*</p>
    </div>
  );
}
...
function PrimitiveLabel4() {
  return (
    <div className="h-[13.995px] relative shrink-0 w-full" data-name="Primitive.label">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[#1a1a1a] text-[14px] text-nowrap top-[-1.74px] whitespace-pre">Latitude</p>
      <MiniModalCadastroPropriedade3 />
    </div>
  );
}
...
function Input4() {
  return (
    <div className="bg-[#f8f8f8] h-[35.983px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[35.983px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#777777] text-[14px] text-nowrap whitespace-pre">Ex: São Paulo - SP</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.994px] h-[57.971px] items-start left-0 top-[327.81px] w-[410.642px]" data-name="Container">
      <PrimitiveLabel4 />
      <Input4 />
    </div>
  );
...
function Container29() {
  return (
    <div className="absolute h-[385.782px] left-0 top-0 w-[410.642px]" data-name="Container">
      <Container24 />
      <Container25 />
      <Container26 />
      <Container27 />
...
function PrimitiveLabel5() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[#1a1a1a] text-[14px] text-nowrap whitespace-pre">Logradouro</p>
    </div>
  );
}
...
function Container30() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.994px] h-[57.971px] items-start left-0 top-0 w-[410.663px]" data-name="Container">
      <PrimitiveLabel5 />
      <Input5 />
    </div>
  );
...
function PrimitiveLabel6() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[#1a1a1a] text-[14px] text-nowrap whitespace-pre">Complemento</p>
    </div>
  );
}
...
function Input6() {
  return (
    <div className="bg-[#f8f8f8] h-[35.983px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[35.983px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#777777] text-[14px] text-nowrap whitespace-pre">Ex: Bloco A, Apto 101</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container31() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.994px] h-[57.971px] items-start left-0 top-[81.95px] w-[410.663px]" data-name="Container">
      <PrimitiveLabel6 />
      <Input6 />
    </div>
  );
...
function MiniModalCadastroPropriedade4() {
  return (
    <div className="absolute h-[13.995px] left-[32.1px] top-0 w-[6.086px]" data-name="MiniModalCadastroPropriedade">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[#fb2c36] text-[14px] text-nowrap top-[-1.74px] whitespace-pre">*</p>
    </div>
  );
}
...
function PrimitiveLabel7() {
  return (
    <div className="h-[13.995px] relative shrink-0 w-full" data-name="Primitive.label">
      <p className="absolute font-['Arimo:Regular',sans-serif] font-normal leading-[14px] left-0 text-[#1a1a1a] text-[14px] text-nowrap top-[-1.74px] whitespace-pre">CEP</p>
      <MiniModalCadastroPropriedade4 />
    </div>
  );
}
...
function Input7() {
  return (
    <div className="bg-[#f8f8f8] h-[35.983px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[35.983px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#777777] text-[14px] text-nowrap whitespace-pre">Ex: BR-1234567890-ABCD</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container32() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.994px] h-[57.971px] items-start left-0 top-[163.91px] w-[410.663px]" data-name="Container">
      <PrimitiveLabel7 />
      <Input7 />
    </div>
  );
...
function PrimitiveLabel8() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[#1a1a1a] text-[14px] text-nowrap whitespace-pre">Numero do CAR</p>
    </div>
  );
}
...
function Input8() {
  return (
    <div className="bg-[#f8f8f8] h-[35.983px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[35.983px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#777777] text-[14px] text-nowrap whitespace-pre">Ex: -23.5505</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container33() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.994px] h-[57.971px] items-start left-0 top-[245.86px] w-[410.663px]" data-name="Container">
      <PrimitiveLabel8 />
      <Input8 />
    </div>
  );
...
function PrimitiveLabel9() {
  return (
    <div className="content-stretch flex gap-[8px] h-[13.995px] items-center relative shrink-0 w-full" data-name="Primitive.label">
      <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[#1a1a1a] text-[14px] text-nowrap whitespace-pre">Longitude</p>
    </div>
  );
}
...
function Input9() {
  return (
    <div className="bg-[#f8f8f8] h-[35.983px] relative rounded-[8px] shrink-0 w-full" data-name="Input">
      <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex h-[35.983px] items-center px-[12px] py-[4px] relative w-full">
          <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[normal] relative shrink-0 text-[#777777] text-[14px] text-nowrap whitespace-pre">Ex: -46.6333</p>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function Container34() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[7.994px] h-[57.971px] items-start left-0 top-[327.81px] w-[410.663px]" data-name="Container">
      <PrimitiveLabel9 />
      <Input9 />
    </div>
  );
...
function Container35() {
  return (
    <div className="absolute h-[385.782px] left-[434.62px] top-0 w-[410.663px]" data-name="Container">
      <Container30 />
      <Container31 />
      <Container32 />
      <Container33 />
...
function Container36() {
  return (
    <div className="h-[385.782px] relative shrink-0 w-full" data-name="Container">
      <Container29 />
      <Container35 />
    </div>
  );
...
function Button26() {
  return (
    <div className="bg-[#0f3d26] h-[35.983px] relative rounded-[8px] shrink-0 w-[69.908px]" data-name="Button">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[35.983px] items-center justify-center px-[16px] py-[8px] relative w-[69.908px]">
        <p className="font-['Arimo:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-center text-neutral-50 text-nowrap whitespace-pre">Salvar</p>
      </div>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="box-border content-stretch flex gap-[11.98px] h-[61.336px] items-start justify-end pb-0 pt-[25.353px] px-0 relative shrink-0 w-full" data-name="Container">
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px_0px_0px] border-solid inset-0 pointer-events-none" />
      <Button25 />
      <Button26 />
    </div>
...
function Form() {
  return (
    <div className="h-[519.062px] relative shrink-0 w-full" data-name="Form">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[23.981px] h-[519.062px] items-start pb-0 pt-[23.981px] px-[23.981px] relative w-full">
          <Container36 />
          <Container37 />
        </div>
      </div>
...
function Container38() {
  return (
    <div className="bg-white h-[599.129px] relative rounded-[10px] shrink-0 w-[895.993px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-[599.129px] items-start overflow-clip p-[1.372px] relative rounded-[inherit] w-[895.993px]">
        <Container23 />
        <Form />
      </div>
      <div aria-hidden="true" className="absolute border-[#e0e0e0] border-[1.372px] border-solid inset-0 pointer-events-none rounded-[10px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)]" />
    </div>
  );
}

function MiniModalCadastroPropriedade5() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.5)] content-stretch flex h-[851.759px] items-center justify-center left-0 top-0 w-[2061.5px]" data-name="MiniModalCadastroPropriedade">
      <Container38 />
    </div>
  );
}
