...
function CardHeader() {
  return (
    <div className="h-[142px] relative shrink-0 w-[446px]" data-name="CardHeader">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[142px] relative w-[446px]">
        <Login />
        <CardTitle />
      </div>
    </div>
...
function Button1() {
  return (
    <div className="bg-[#0f3d26] h-[36px] relative rounded-[10px] shrink-0 w-full" data-name="Button">
...
function Paragraph() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal leading-[20px] left-[199.45px] not-italic text-[#777777] text-[14px] text-center text-nowrap top-0 translate-x-[-50%] whitespace-pre">Credenciais de acesso ao protótipo:</p>
    </div>
  );
}
...
function Login2() {
  return (
    <div className="box-border content-stretch flex flex-col h-[45px] items-start pb-0 pt-[25px] px-0 relative shrink-0 w-full" data-name="Login">
...
function Card() {
  return (
    <div className="bg-[rgba(255,255,255,0.95)] box-border content-stretch flex flex-col gap-[24px] h-[453px] items-start p-px relative rounded-[16px] shrink-0 w-full" data-name="Card">
...
function Container3() {
  return (
    <div className="h-[497px] relative shrink-0 w-[448px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col gap-[24px] h-[497px] items-start relative w-[448px]">
        <Card />
        <Paragraph1 />
      </div>
    </div>
