...
export function DashboardColeta() {
  ...
  return (
    <div className="px-6 pb-6 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              <button className="w-full bg-primary text-primary-foreground hover:bg-primary/90 rounded-[12px] px-4 py-2 flex items-center justify-center gap-2 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              {coletadasEspecies.map((especie, index) => (
                <div
                  key={index}
                  className="bg-[#F8F8F8] dark:bg-[#1E2621] border border-[#E0E0E0] dark:border-border rounded-[12px] p-3"
                >
      ...
      {/* Calendário Mensal das Matrizes */}
      <div className="bg-white dark:bg-card border border-[#E0E0E0] dark:border-border rounded-[12px] p-6 shadow-sm">
        <div className="mb-8">
          <h2 className="text-[#1A1A1A] dark:text-white mb-1">
            Calendário Mensal das Matrizes - <span className="text-green-600">{currentMonth}</span>
          </h2>
          <p className="text-[#777777] dark:text-[#B0B0B0] text-sm">
            Árvores-matrizes monitoradas neste mês
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              {florescendoMatrizes.map((matriz, index) => (
                <div
                  key={index}
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              {frutificandoMatrizes.map((matriz, index) => (
                <div
                  key={index}
                  className="bg-[#F8F8F8] dark:bg-[#1E2621] border border-[#E0E0E0] dark:border-border rounded-[12px] p-3 space-y-1"
                >
